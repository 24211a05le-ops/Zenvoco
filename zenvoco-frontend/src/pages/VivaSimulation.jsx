            ...
            <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl p-16 text-center shadow-[0_0_50px_rgba(0,0,0,0.5)]">
              ...
              <div className="flex justify-center gap-6 mt-12">
                <button
                  ...
                  className="px-8 py-4 bg-green-600 hover:bg-green-500 text-white rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:-translate-y-1"
                >
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl p-8">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-black/40 border border-gray-800 rounded-2xl p-6 text-center">
                  ...
                  <p className="text-4xl font-bold text-green-400">82<span className="text-xl">%</span></p>
                </div>
                <div className="bg-black/40 border border-gray-800 rounded-2xl p-6 text-center">
                  <p className="text-gray-400 text-sm mb-2 uppercase tracking-wider font-semibold">Clarity</p>
                  <p className="text-4xl font-bold text-blue-400">78<span className="text-xl">%</span></p>
                </div>
                <div className="bg-black/40 border border-gray-800 rounded-2xl p-6 text-center">
                  <p className="text-gray-400 text-sm mb-2 uppercase tracking-wider font-semibold">Confidence</p>
                  <p className="text-4xl font-bold text-purple-400">75<span className="text-xl">%</span></p>
                </div>
                <div className="bg-black/40 border border-gray-800 rounded-2xl p-6 text-center">
                  <p className="text-gray-400 text-sm mb-2 uppercase tracking-wider font-semibold">Filler Words</p>
                  <p className="text-4xl font-bold text-red-400">Low</p>
                </div>
              </div>
            </div>
          </div>
